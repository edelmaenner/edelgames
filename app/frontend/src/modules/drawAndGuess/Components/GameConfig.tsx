...
import RangeSlider, {
	renderPreviewMethods,
} from '../../../framework/components/Inputs/RangeSlider';
...
export default class GameConfig extends Component<IProps, IState> {
	...
	renderRangeSliderConfig(
		...
		renderPreview:
			| undefined
			| ((value: number) => string | number | JSX.Element) = undefined
	): JSX.Element {
		return (
