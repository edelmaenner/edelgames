...
import {ColorGrid, defaultGrid} from "@edelgames/types/src/modules/colorChecker/CCTypes";
...
export default class ColorCheckerGame extends React.Component<{}, IState> implements ModuleGameInterface {
