...
export default class TeamSelectionComponent extends React.Component<Props, {}> {
	...
	render() {
		return (
			<div
				id={'teamSelection' + this.props.team.name}
				className={'teamSelection teams' + this.props.teamCount}
			...
			>
				...
				<div className={'roleChoice'}>
					<div
						...
						className={'roleList spymaster'}
					>
						<span>{this.props.team.spymaster}</span>
					</div>
					<button
						id={'beSpymaster' + this.props.team.name}
						onClick={this.setSpymaster.bind(this)}
				...
				<div className={'roleChoice'}>
					<div
						...
						className={'roleList investigators'}
					>
					...
					<button
						id={'joinInvestigator' + this.props.team.name}
						onClick={this.joinInvestigator.bind(this)}
						className={'joinButton'}
					>
