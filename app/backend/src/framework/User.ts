...
export default class User {
	...
	constructor(socket: Socket) {
		...
		SocketMessenger.subscribeEventToSocket(
			socket,
			'userLoginAttempt',
		...
		SocketMessenger.subscribeEventToSocket(
			...
			this.refreshLobbyRoomData.bind(this)
		);
		SocketMessenger.subscribeEventToSocket(
			socket,
			'createNewRoom',
			this.createNewRoom.bind(this)
		);
		SocketMessenger.subscribeEventToSocket(
			socket,
			'returnToLobby',
			this.returnToLobby.bind(this)
		);
		SocketMessenger.subscribeEventToSocket(
			socket,
			'joinRoom',
