...
import {GridPlayerScore, GridScoreboard} from "@edelgames/types/src/modules/colorChecker/CCTypes";
...
export default class WinningScreen extends Component<IProps, IState> {
    ...
    render() {
        return (
            <div className={'winning-screen'}>
                ...
                <div className={'scoreboard ' + (this.state.currentGridOwner ? 'grid-visible' : '')}>
                    <div className={'scoreboard-column'}>
                        <div className={'scoreboard-cell'}>Spieler <span className={'spacer-v'}></span></div>
                ...
                <div>
                    {this.state.currentGridOwner ?
                        this.renderGrid(this.props.scoreboard.find((score) => {
    ...
    onClickPlayersHead(playerId: string): void {
        this.setState({
            currentGridOwner: playerId === this.state.currentGridOwner ? undefined : playerId
        });
    }
    ...
    renderColumn(score: GridPlayerScore, index: number): JSX.Element {
        return (
            <div className={'scoreboard-column'}>
                <div className={'scoreboard-cell'} onClick={this.onClickPlayersHead.bind(this, score.player)}>
